...
dict_cn = {}
privance_cn = set()
for i in range(len(data_express)):
    privance_cn.add((data_express[i][1][0:3]))
list_cn = list(privance_cn)
for i in list_cn:
    dict_cn[i] = []


for j in list_cn:
    for x in range(len(data_express)):
        if j == data_express[x][1][0:3]:
            dict_cn[j].append(data_express[x])
#             # print(data_express[x][1][0:3])
# print((privance_cn))
print(dict_cn["北京市"])
...
# {'⻘海省': ['郭*', '⻘海省⻄宁市互助东路12号海亮⼤都汇'],
#  '⼭⻄省': ['杨*杰', '⼭⻄省忻州市京原南路雷神⽹咖'],
#  '⼭东省': ['单*成', '⼭东省⽇照市⽇照职业技术学院'],
#  '⽢肃省': ['谢*星', '⽢肃省酒泉市雄关路54号东⻛物流⼗号'],
#  '⿊⻰江': ['王*超', '⿊⻰江省哈尔滨市永泰城3号楼1单位1304'],
#  '上海市': ['韩*红', '上海市杨浦区隆昌路619号10号楼⼆楼'],
#  '内蒙古': ['张*锋', '内蒙古呼和浩特市双河镇莹昱佳苑商铺A段13号（防汛东巷莲爱粮油副⻝⻔市）'],
#  '北京市': ['杨*康', '北京市丰台区丰台科技园汉威⼴场12栋'],
#  '吉林省': ['梁*升', '吉林省吉林市承德街45号吉林化⼯学院'],
#  '天津市': ['郭*', '天津市⻄⻘区侯台碧⽔家园e区'],
#  '宁夏银': ['陈*刚', '宁夏银川市上海东路银佐家园东区11-1-501'],
#  '安徽省': ['顾*⽣', '安徽省⾩阳市清河⻄路100号⾩阳师范学院'],
#  '新疆乌': ['唐*宁', '新疆乌鲁⽊⻬市新疆省乌鲁⽊⻬头屯河区⽕⻋⻄站6街'],
#  '新疆巴': ['张*俊', '新疆巴⾳郭楞州⽯化⼤道塔指1区25栋403'],
#  '新疆阿': ['伍*葵', '新疆阿克苏地区红旗坡⼗⼀队'],
#  '江苏省': ['孙*康', '江苏省南京市化⼯园⽅⽔东路9号'],
#  '河北省': ['刘*仪', '河北省廊坊市燕郊经济开发区 华北科技学院'],
#  '河南省': ['侯*', '河南省郑州市河南省郑州市⾼新区莲花街牡丹路⻄雅图荣邦城'],
#  '浙江省': ['朱*', '浙江省杭州市⻰湖春江郦城'],
#  '海南省': ['朱*北', '海南省海⼝市和平北路三亚上⼆街9号'],
#  '湖北省': ['刘*', '湖北省武汉市左岭新城1社区15栋'],
#  '辽宁省': ['曹*政', '辽宁省⼤连市⼤连理⼯⼤学软件学院'],
#  '陕⻄省': ['王*', '陕⻄省⻄安市⼗⾥铺街⻓⼒⼩区北⻔对⾯（王家辣⼦⾯）']}
